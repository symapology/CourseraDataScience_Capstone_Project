...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(data_frame, names='site-dropdown', values='class' ,title='Total Launches for All Sites')
        return fig
    else:
        specific_df=spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        fig = px.pie(data_frame, names='site-dropdown', values='class', title='Total Launch for a Specific Site')
        return fig
# TASK 4:
